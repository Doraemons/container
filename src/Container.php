...
use Doraemons\Container\Exception\BindingResolutionException;
use Doraemons\Container\Contracts\Container as ContainerContracts;
...
class Container implements ContainerContracts, ArrayAccess
{
     ...
     * @return void
     */
    public static function setInstance(ContainerContracts $container)
    {
